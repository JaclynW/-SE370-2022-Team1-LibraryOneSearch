...
/**
 * The {@code GUISearch} class organizes the GUI elements of the Search Page
 * @author Jaclyn Walsh
 */
public class GUISearch extends JPanel implements ActionListener {
    /**
     * Container which holds the components of the Search Page
     */
    private JPanel searchScreen, top, center, bottom;
    /**
     * The push button instances
     */
    private JButton search, summary;
    /**
     * Container which holds the user search input
     */
    private JTextField textField;
    /**
     * Checkboxes where user determines name of Library District
     */
    private JCheckBox branchOption1, branchOption2, branchOption3, branchOption4, branchOption5, branchOption6;
    /**
     * The heading of the Search Page
     */
    private JLabel title;
    /**
     * Hold user input for search string and library district
     */
    private String searchString, selectedBranch;
    /**
     * The array of all Library Districts
     */
    private ArrayList<String> selectedBranches;
    /**
     * Creates a new GUI Search instance
     */
    public GUISearch() {
    ...
    /**
     * The action listener for the Search Page
     */
